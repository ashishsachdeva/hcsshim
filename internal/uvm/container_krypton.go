...
func (container *KryptonContainer) WaitChannel() <-chan struct{} {
	return container.waitBlock
}

func (container *KryptonContainer) WaitError() error {
	return errors.New("WaitError API is not implemented for Krypton")
}
